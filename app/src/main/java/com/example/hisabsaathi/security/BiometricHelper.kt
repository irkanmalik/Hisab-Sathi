...
object BiometricHelper {
    ...
    fun authenticate(
        ...
        title: String = "HisabSaathi Secure Vault",
        subtitle: String = "Authenticate with fingerprint or face unlock to access financial records",
        ...
        val biometricPrompt = BiometricPrompt(
            ...
            object : BiometricPrompt.AuthenticationCallback() {
                ...
                override fun onAuthenticationFailed() {
                    ...
                    // Prompt can re-try, or error handled
                }
            }
        )
